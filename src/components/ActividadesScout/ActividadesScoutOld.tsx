...
import { Calendar, Users, MapPin, Save, Clock, Star, Trophy, Edit, Trash2, Plus, AlertCircle, Search } from 'lucide-react';
...
interface FormularioActividad {
  ...
  objetivos_educativos: string;
  observaciones: string;
}

export default function ActividadesScoutMigrated() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const actividadData = {
        ...
        rama_objetivo: formData.rama_objetivo as any,
      ...
      if (modoEdicion) {
        // Actualizar actividad existente - por ahora solo limpiamos el formulario
        // TODO: Implementar función de actualización en ScoutService
        console.log('Actualizando actividad:', modoEdicion, actividadData);
      } else {
  ...
  const editarActividad = (actividad: ActividadScout) => {
    setFormData({
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-4 pt-6 border-t border-white/20">
              ...
              >
                ...
                {loading ? 'Guardando...' : (modoEdicion ? 'Actualizar Actividad' : 'Crear Actividad')}
              </button>
            </div>
          </form>
        </div>
