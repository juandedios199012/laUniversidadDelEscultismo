...
function mapScoutToFormData(scout: Scout): ScoutFormData {
  ...
  return {
    ...
    estatura_cm: scout.estatura_cm != null ? Number(scout.estatura_cm) : null,
    peso_kg: scout.peso_kg != null ? Number(scout.peso_kg) : null,
    ...
    condiciones: scout.condiciones || [],
    alergias: scout.alergias || [],
    medicamentos: scout.medicamentos || [],
    vacunas: scout.vacunas || [],
