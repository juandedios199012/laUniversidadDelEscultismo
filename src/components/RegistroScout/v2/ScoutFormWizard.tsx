...
function mapScoutToFormData(scout: Scout): ScoutFormData {
  ...
  return {
    ...
    estatura_cm: (scout as any).estatura_cm != null ? Number((scout as any).estatura_cm) : null,
    peso_kg: (scout as any).peso_kg != null ? Number((scout as any).peso_kg) : null,
    ...
    condiciones: (scout as any).condiciones || [],
    alergias: (scout as any).alergias || [],
    medicamentos: (scout as any).medicamentos || [],
    vacunas: (scout as any).vacunas || [],
