/**
 * Plantilla PDF para Registro Institucional de Colaboradores
 * Clon independiente de DNGI02Template.tsx (usado por el módulo de
 * Dirigentes): mismo formato visual, pero generalizado para el módulo de
 * Colaboradores (no usa el código oficial "DNGI-02", específico de
 * dirigentes reales de Scouts del Perú).
...
interface ColaboradorRegistroTemplateProps {
...
export const ColaboradorRegistroTemplate: React.FC<ColaboradorRegistroTemplateProps> = ({
  colaborador,
  metadata = {},
}) => {
  const fechaActual = metadata.fechaGeneracion || new Date().toLocaleDateString('es-PE');
  const sexoTexto = colaborador.persona.sexo === 'M' ? 'M' : colaborador.persona.sexo === 'F' ? 'F' : '';
  const fechaNac = colaborador.persona.fecha_nacimiento
    ? parseLocalDate(colaborador.persona.fecha_nacimiento).toLocaleDateString('es-PE')
    : '';
  ...
  const renderHeader = (pageNumber: number, totalPages: number = 3) => (
    <View style={styles.headerContainer}>
      ...
      <View style={styles.infoSection}>
        <Text style={styles.infoText}>Código: REG-COL-01</Text>
  ...
  const renderFooter = () => (
    <Text style={styles.footer}>
      * Documento interno del Grupo Scout — no reemplaza el registro oficial ante la Asociación de Scouts del Perú.
    </Text>
  );
    ...
    <Document>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.instructions}>
          <Text style={styles.boldText}>Estimado(a) Colaborador(a)</Text>
          ...
          documento de identidad (DNI o Carné de Extranjería) para el proceso de registro.
        </Text>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRowLast}>
            <View style={[styles.tableCell, styles.tableCellBorder, { width: '50%' }]}>
              <Text>{colaborador.persona.apellidos || ''}</Text>
            </View>
            <View style={[styles.tableCell, { width: '50%' }]}>
              <Text>{colaborador.persona.nombres || ''}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRowLast}>
            ...
            <View style={[styles.tableCell, styles.tableCellBorder, { width: '30%' }]}>
              <Text>{getTipoDocumentoLabel(colaborador.persona.tipo_documento) || 'DNI'}</Text>
            </View>
            <View style={[styles.tableCell, { width: '30%' }]}>
              <Text>{colaborador.persona.numero_documento || ''}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRowLast}>
            <View style={[styles.tableCell, styles.tableCellBorder, { width: '33%' }]}>
              <Text>{colaborador.persona.religion || ''}</Text>
            </View>
            <View style={[styles.tableCell, styles.tableCellBorder, { width: '34%' }]}>
              <Text>{colaborador.persona.correo_institucional || ''}</Text>
            </View>
            <View style={[styles.tableCell, { width: '33%' }]}>
              <Text>{colaborador.persona.correo || ''}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRowLast}>
            <View style={[styles.tableCell, styles.tableCellBorder, { width: '20%' }]}>
              <Text>{colaborador.region_scout || ''}</Text>
            </View>
            <View style={[styles.tableCell, styles.tableCellBorder, { width: '20%' }]}>
              <Text>{colaborador.localidad_scout || ''}</Text>
            </View>
            <View style={[styles.tableCell, styles.tableCellBorder, { width: '15%' }]}>
              <Text>{colaborador.numeral_grupo || ''}</Text>
            </View>
            <View style={[styles.tableCell, styles.tableCellBorder, { width: '20%' }]}>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRowLast}>
            <View style={[styles.tableCell, styles.tableCellBorder, { width: '75%' }]}>
              <Text>{colaborador.persona.direccion || ''}</Text>
            </View>
            <View style={[styles.tableCell, { width: '25%' }]}>
              <Text>{colaborador.persona.codigo_postal || ''}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRowLast}>
            <View style={[styles.tableCell, styles.tableCellBorder, { width: '33%' }]}>
              <Text>{colaborador.persona.departamento || ''}</Text>
            </View>
            <View style={[styles.tableCell, styles.tableCellBorder, { width: '34%' }]}>
              <Text>{colaborador.persona.provincia || ''}</Text>
            </View>
            <View style={[styles.tableCell, { width: '33%' }]}>
              <Text>{colaborador.persona.distrito || ''}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRowLast}>
            <View style={[styles.tableCell, styles.tableCellBorder, { width: '33%' }]}>
              <Text>{colaborador.persona.carnet_conadis || ''}</Text>
            </View>
            <View style={[styles.tableCell, styles.tableCellBorder, { width: '34%' }]}>
              <Text>{colaborador.persona.tipo_discapacidad || ''}</Text>
            </View>
            <View style={[styles.tableCell, { width: '33%' }]}>
              <Text>{colaborador.persona.profesion || ''}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRowLast}>
            <View style={[styles.tableCell, styles.tableCellBorder, { width: '25%' }]}>
              <Text>{colaborador.persona.grupo_sanguineo || ''}</Text>
            </View>
            <View style={[styles.tableCell, styles.tableCellBorder, { width: '25%' }]}>
              <Text>{colaborador.persona.factor_sanguineo || ''}</Text>
            </View>
            <View style={[styles.tableCell, styles.tableCellBorder, { width: '25%' }]}>
              <Text>{colaborador.persona.seguro_medico || ''}</Text>
            </View>
            <View style={[styles.tableCell, { width: '25%' }]}>
              <Text>{colaborador.persona.celular || ''}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRowLast}>
            <View style={[styles.tableCell, { width: '100%', minHeight: 85 }]}>
              <Text>{colaborador.persona.descripcion_discapacidad || ''}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRowLast}>
            <View style={[styles.tableCell, styles.tableCellBorder, { width: '80%' }]}>
              <Text>{colaborador.centro_estudios || ''}</Text>
            </View>
            <View style={[styles.tableCell, { width: '20%' }]}>
              <Text>{colaborador.ciclo_anio_estudios || ''}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRowLast}>
            <View style={[styles.tableCell, styles.tableCellBorder, { width: '50%' }]}>
              <Text>{colaborador.centro_laboral || ''}</Text>
            </View>
            <View style={[styles.tableCell, { width: '50%' }]}>
              <Text>{colaborador.cargo_laboral || ''}</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.table}>
          ...
          <View style={styles.tableRowLast}>
            <View style={[styles.tableCell, styles.tableCellBorder, { width: '50%' }]}>
              <Text>{colaborador.contacto_emergencia?.nombre || ''}</Text>
            </View>
            <View style={[styles.tableCell, styles.tableCellBorder, { width: '25%' }]}>
              <Text>{colaborador.contacto_emergencia?.telefono || ''}</Text>
            </View>
            <View style={[styles.tableCell, { width: '25%' }]}>
              <Text>{colaborador.contacto_emergencia?.parentesco || ''}</Text>
            </View>
          </View>
        </View>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.sectionTitle}>Como Colaborador(a):</Text>
        ...
        <View style={styles.antecedentesBox}>
          <Text>{colaborador.detalle_antecedentes || ''}</Text>
        </View>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.normalText}>
          ...
          <Text style={styles.boldText}>FORMATO DE REGISTRO DE COLABORADORES</Text>
        ...
        <Text style={styles.normalText}>• Certificado curso SFH1 para Adultos Voluntarios (si aplica).</Text>
...
export default ColaboradorRegistroTemplate;
