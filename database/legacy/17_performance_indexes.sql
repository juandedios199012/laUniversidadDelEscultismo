...
-- Presupuestos por tipo y estado
CREATE INDEX IF NOT EXISTS idx_presupuestos_tipo_estado 
    ON presupuestos(tipo_presupuesto, estado);
...
-- ============= INDICES PARA INSCRIPCIONES ANUALES =============
